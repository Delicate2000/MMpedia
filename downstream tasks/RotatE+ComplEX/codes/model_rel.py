...
class KGEModel(nn.Module):
    ...
    def forward(self, sample, mode='single'):
        ...
        if mode == 'single':
            ...
            # print("sample0:", sample[0].size)
            # print("sample1:", sample[1].size)
            batch_size, negative_sample_size = tail_part.size(0), tail_part.size(1)
            # print("batch_size:", batch_size)
            # print("negative_sample_size:", negative_sample_size)
            # print("tail_part.view(-1):",tail_part.view(-1))
    ...
    def ComplEx(self, head, relation, tail, mode):
        ...
        # print("im_head:", head.size())
        # print("re_head:", re_head.size())
        
        # print("im_tail:", im_tail.size())
        # print("re_tail:", tail.size())
